      ...
      <div className='mx-2 my-4 w-[330px] mainpage-Card'>
        <div className='flex flex-col'>
          <div className='w-full relative'>
            <img src={video?.thumbnail[0]?.url} className='w-full rounded-xl object-cover mainpage-thumbnail cursor-pointer' onClick={Render} alt="logo" />
          ...
          <div className={`flex px-3 my-2 text-${theme === 'light'?'black':'white'}`}>
            {video.channelThumbnail && <img src={video.channelThumbnail[0].url} className='rounded-full self-start mainpage-channelThumbnail' alt="" />}
            <div className='mx-3'>
              ...
              <div className='my-1 text-gray-00'>
                <div className='flex sm:text-xs mainpage-channelTitle'>
                  <h4 className='font-semibold cursor-pointer' onClick={gotoChannel}>{video.channelTitle} </h4>
