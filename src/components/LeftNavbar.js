...
const LeftNavbar = () => {
  ...
  return (
    <>
        <nav className=' h-[93vh] bg-white w-[65px] flex flex-col items-center fixed left-0 top-[60px] hide'>
            <ul>
                ...
                <li className='my-5 flex flex-col items-center cursor-pointer'><i className="fa-solid fa-play fa-lg my-5"></i><h6 className=' text-[0.6rem]'>Shorts</h6></li>
